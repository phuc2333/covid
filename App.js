...
export default function App() {
  ...
  return (
      ...
      <View>
        ...
        <TextInput
        style={{height: 30,width:360,borderWidth:1,borderColor:'gray',borderRadius:8,marginBottom:10,paddingLeft:10}}
        placeholder="Họ và tên(ghi chữ IN HOA)"
      />
      <Text>Giới tính *</Text>
       <DropDownPicker
       style={{height: 30,width:360,borderWidth:1,borderColor:'gray',borderRadius:8,flexDirection:'row',padding:3,marginBottom:10}}
      open={open}
      value={value}
      items={items}
      setOpen={setOpen}
    ...
    <View style={{flexDirection:'row',justifyContent:"space-between"}}>
      <View>
      <DropDownPicker
       style={{height: 30,width:90,marginBottom:10,borderWidth:1,borderColor:'gray',borderRadius:8,flexDirection:'row',padding:3}}
      open={openday}
      value={valueday}
      items={itemsday}
      setOpen={setOpenday}
   ...
   <View>
   <DropDownPicker
       style={{height: 30,width:100,marginBottom:10,borderWidth:1,borderColor:'gray',borderRadius:8,flexDirection:'row',padding:3}}
      open={openmoth}
      value={valuemonth}
      items={itemsmonth}
    ...
    <TextInput
      ...
      <View>
        ...
        <DropDownPicker
      style={{height: 30,width:360,marginBottom:10,borderWidth:1,borderColor:'gray',borderRadius:8,flexDirection:'row',padding:3}}
      open={opentinh}
      value={valuetinh}
      items={itemstinh}
      setOpen={setOpentinh}
    ...
    />
      <DropDownPicker
      style={{height: 30,width:360,marginBottom:10,borderWidth:1,borderColor:'gray',borderRadius:8,flexDirection:'row',padding:3,marginBottom:30}}
      open={openxa}
      value={valuexa}
      items={itemsxa}
      setOpen={setOpenxa}
